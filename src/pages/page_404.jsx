  ...
  return (
    <div className={`${page404.section} mt-20 `}>
      ...
      <p className={`${page404.title} mt-5  text text_type_main-default text_color_inactive`}>
        можешь вернуться <Button type="secondary" size="medium" onClick={(e) => goToBackPage(e)}>назад</Button>
        , или перейти на <Button type="secondary" size="medium" onClick={(e) => goToMainPage(e)}>главную</Button>
      </p>
    </div>
  )
}
