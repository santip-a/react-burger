...
const BurgerConstructor: FC= () => {
  ...
  const fillings: any[] = useSelector(state => state.ingredientsInConstructor.filling);
  ...
  const priceFillings = useMemo(() => {
    return fillings.reduce(function (sum: number, current: any) {
  ...
  const requestNumberOrder = (listId: any[]) => {
    if (userAuth) {
      setModalOpen(true);
